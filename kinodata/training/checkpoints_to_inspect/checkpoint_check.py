...
healthy_checkpoint_20 = torch.load("model_all_ok_epoch_25.pt")   
nan_checkpoint = torch.load("model_nan_detected_epoch_25.pt") 
#nan_checkpoint = torch.load("model_all_ok_epoch_15.pt")
