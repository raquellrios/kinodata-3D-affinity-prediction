...
wandb.init(entity="nextaids", project="kinodata-3d_rmsd10", name=project_name, group="experiment_iris_focalloss_randon_wa", mode="online", settings=wandb.Settings(silent="false"))
