...
wandb.finish()
wandb.init(entity="nextaids", project="kinodata_extended", name="rmsd_4", mode="online", settings=wandb.Settings(silent="false"))
...
def train(config, fn_data, fn_model=None):
 ...
 ###
    ...
    print("printing inside the train.py")
