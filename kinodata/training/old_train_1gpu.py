...
df_train = predict_df(model, data_module.train_dataloader(), prediction_trainer, ckpt_path="best")
df_val = predict_df(model, data_module.val_dataloader(), prediction_trainer, ckpt_path="best")
df_test = predict_df(model, data_module.test_dataloader(), prediction_trainer, ckpt_path="best")
