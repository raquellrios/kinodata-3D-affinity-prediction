...
project_name="8cpus_2gpus_x2_pose_lilac_logits_normalised_act_soft_kfold1_clean_reg_datamod_test"
...
def get_safe_num_workers():
    try:
        return max(2, int(len(os.sched_getaffinity(0)) // torch.cuda.device_count()) - 2)
    except:
        return 4
...
config["csv_save_dir"]="/data/chodera/lopezrir/kinodata-3D-affinity-prediction/kinodata/training/data_runs/2gpus_8cpus_x2_pose_logits_normalised_act_soft_kfold1_cleanscript_reg_datamod_datasets_test"
