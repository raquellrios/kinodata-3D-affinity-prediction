...
project_name="iris_32cpus_nopose"
wandb.init(entity="nextaids", project="kinodata-3d_rmsd10", name=project_name, mode="online", id="g17fbgdp", resume="must", settings=wandb.Settings(silent="false"))
...
config["csv_save_dir"]="/data1/choderaj/lopezrir/kinodata-3D-affinity-prediction/kinodata/training/data_runs/iris_32cpus_nopose"
...
def train(config, fn_data, fn_model=None):
    ...
    trainer.fit(model, datamodule=data_module, ckpt_path="checkpoints_nopose/last.ckpt")
